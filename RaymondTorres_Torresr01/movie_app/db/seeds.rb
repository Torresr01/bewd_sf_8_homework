  Movie.delete_all
    ...
    Movie.create! title: 'Casablanca', description:'classic movie', year_released:1924
    Movie.create! title: 'Ghostbusters',  description:'Ghost and stuff', year_released:1984
    Movie.create! title: 'Short Circuit', description: 'No ghost in this movie', year_released:1985 
